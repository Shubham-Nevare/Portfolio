      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-4 mb-12">
            <a
              href="https://drive.google.com/file/d/19Z7YAlj_N2y6fdA2Vo25K3rUkXbX2Y0D/view?usp=sharing"   
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://drive.google.com/uc?export=download&id=19Z7YAlj_N2y6fdA2Vo25K3rUkXbX2Y0D"
              download
              target="_blank"
              rel="noopener noreferrer"
